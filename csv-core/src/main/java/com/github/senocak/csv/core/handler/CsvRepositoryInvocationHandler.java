 ...
 */
public class CsvRepositoryInvocationHandler implements InvocationHandler {
    ...
    public CsvRepositoryInvocationHandler(final Class<?> repositoryInterface, final Class<?> entityClass,
                                          final String csvPath, final Class<?> idClass) {
    ...
    @NonNull
    private Optional<?> findById(final Object id) {
        try {
    ...
    private Iterable<?> saveAll(final Iterable<?> entities) {
        try {
            final List<Object> all = new ArrayList<>(findAll());
    ...
    private void deleteById(final Object id) {
        try {
            final List<Object> all = new ArrayList<>(findAll());
    ...
    private boolean existsById(final Object id) {
     ...
     */
    @Nullable
    private Object executeDerivedQuery(@NonNull final Method method, final Object[] args) {
     ...
     */
    private Predicate<Object> buildPredicate(final @NonNull PartTree partTree, final Object[] args) {
     ...
     */
    private Predicate<Object> createPredicate(final String propertyName, final Enum<?> type, final Object value) {
        return entity -> {
            try {
     ...
     */
    @Nullable
    private Object getPropertyValue(final Object entity, final String propertyPath) {
        try {
